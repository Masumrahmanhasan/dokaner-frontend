...
const Header = (props) => {
  const { auth, total_wishlist, user, site_name, frontend_logo_menu, loadCustomerCart } = props;
                ...
                <div className='dropdown cart-dropdown'>
                  ...
                  >
                    <div className='icon'>
                      ...
                      <span className='ml-2 fw-bold d-md-inline d-none nav-item-text'>
                        {auth.isShopAsCustomer ? auth.shopAsCustomer.name : user?.name || "Customer"}
                        {/* {user?.name || "Customer"} */}
                      </span>
                    </div>
                  </Link>
                  <div className='dropdown-menu dropdown-menu-right nav_customer_menus'>
                    ...
                    {auth.role === "administrator" && (
                      <Link to='/dashboard/shop-as-customer' className='dropdown-item'>
                        Shop as customer
                      </Link>
                    )}
...
export default connect(mapStateToProps, { loadCustomerCart, customerWishlist })(withRouter(Header));
