                    ...
                    <div className='card-body'>
                      <div id='exportOrder' ref={componentRef}>
                                  ...
                                  <div className='card my-2 hov-shadow '>
                                    ...
                                    <div className='card-body border px-2 py-0 py-md-1'>
                                      ...
                                      <div className='details py-1 py-md-3'>
                                        <div className='collapse' id={`collapseDetails${index}`}>
                                          {item_variations.length > 0 ? (
                                            ...
                                            >
                                              ...
                                              <div className='col-md-4 col-6 plain-attribute text-right'>
                                                <b>Price :</b>
                                                <span>
                                                  {Number(item.product_value) / Number(item.quantity)}
                                                </span>
                                              </div>
                                          ...
                                          <div className='row' style={{ borderTop: "1px solid lightGray" }}>
                                            <div className='col-6'>
                                              ...
                                              <span>
                                                {currency} {numberWithCommas(item.chinaLocalDelivery)}
                                              </span>
                                            </div>
                                            <div className='col-6 text-right'>
                                              <b> SubTotal/Product Value :</b>
                                              <span>
                                                {currency} {numberWithCommas(Number(item.product_value))}
                                              </span>
                                            </div>
                                          </div>
                                              ...
                                              <span>
                                                ...
                                                {numberWithCommas(
                                                  Number(item.product_value) -
                                                    Number(item.coupon_contribution) +
                                          ...
                                          <div className='row' style={{ borderTop: "1px solid lightGray" }}>
                                            <div className='col-12 text-right'>
                                              <span>
                                                <b> Shipping Per KG</b> (Total Weight({item.actual_weight}) *
                                                Shipping Fee ({currency} {item.shipping_rate})) <b>:</b>
                                              </span>
                                        ...
                                        <div>
                                          <button
                                            class='btn expand btn-default btn-block bold'
                                            type='button'
                        ...
                        <div className='card my-2'>
                          <div className='card-header border border-bottom-0 px-2 py-0 py-md-2'>
                            <p className='bold  baseColor text-uppercase pb-0 mb-0'>Order summary</p>
                          </div>
                          <div className='card-body border px-2 py-0 py-md-4'>
                            <div className='text-right'>
                              ...
                              <p>
                                ...
                                {`${currency} ${numberWithCommas(getCourierBill() + getShippingBill())}`}
                              </p>
                              <p>
                                <b>Subtotal : </b>
                                {`${currency} ${numberWithCommas(getTotalValue(order.amount))}`}
                              </p>
                              <p>
                                <b>Initial Payment : </b>
                              ...
                              <p>
                                <b>Final Payment : </b>
                                {`${currency} ${numberWithCommas(getTotalValue(order.dueForProducts))}`}
                              </p>
                              <div className='text-right'>
                                {trxIds.payment_2nd ? (
                                  "Paid"
