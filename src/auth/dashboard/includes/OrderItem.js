      ...
      <div className='card-header border border-bottom-0 px-2 py-0 py-md-4'>
        <div className='d-flex justify-content-between align-items-center'>
          ...
          <div className='text-right'>
            ...
            <p className='m-0'>
              Day: {getBusinessDateCount(item.order.order_approved_at, ready_to_deliver_at)}
            </p>
          </div>
        </div>
        {item.status === "refunded" ? (
          <div className={`d-flex justify-content-center flex-column align-items-center p-0 p-md-2`}>
            ...
            <p className='text-center text-uppercase status-title animate-charcter bold'>Refunded</p>
            ...
            {stausArr1.map((el, i) => {
              ...
              return (
                ...
                >
                  ...
                  <br />
                  {el.status === item.status && <span>{item.updated_at.slice(0, 10)}</span>}
                </li>
              );
            })}
          </ol>
